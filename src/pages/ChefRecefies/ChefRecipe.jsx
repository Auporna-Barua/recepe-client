    ...
    <div className="border-2 border-orange-400 rounded mt-10  hover:bg-orange-400 hover:bg-opacity-20 duration-500">
      <div className="grid grid-cols-3 gap-5">
        ...
        <div className="w-full col-span-2 p-5">
          <p className="font-bold text-2xl border-b-4 border-orange-400 w-fit pb-2">
            {recipe_name}
          </p>
          <p className="mt-2 font-semibold text-base">{cooking_mathod}</p>
          <p className="font-bold text-2xl border-b-4 border-orange-400 w-fit pb-2 mt-3">
            Ingredients
          </p>
          <p className="mt-2">
            {ingredients.map((li) => (
          ...
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              disabled={disabled}
              className="btn text-base text-black bg-orange-400 border-none mt-10 hover:bg-orange-400"
            >
